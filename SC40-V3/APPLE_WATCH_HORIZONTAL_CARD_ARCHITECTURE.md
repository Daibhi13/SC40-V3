...
- [ ] **Background Gradient**: Exact iPhone TrainingView colors
- [ ] **Golden Button**: Identical START SPRINT button styling
- [ ] **Card Gradients**: Match iPhone session type colors
- [ ] **Typography**: Scaled iPhone font weights and tracking
- [ ] **Glass Effects**: Replicate iPhone overlay opacity
- [ ] **Shadows**: Consistent depth and blur radius
- [ ] **Animations**: Smooth card transitions like iPhone
