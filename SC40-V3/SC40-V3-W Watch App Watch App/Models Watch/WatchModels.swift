...
// MARK: - Safe Decoding Extension
extension JSONDecoder {
    static let safeDecoder: JSONDecoder = {
...
public struct TrainingSession: Codable, Identifiable, Sendable {
    ...
    public var safeType: String {
        return type.isEmpty ? "Speed Training" : type
    }
    
    public var safeFocus: String {
        return focus.isEmpty ? "Performance Development" : focus
    }
    
    public var safeNotes: String {
        return notes?.isEmpty == false ? notes! : "No additional notes"
    }
