...
let sessionLibrary: [SprintSessionTemplate] = [
    ...
    // MARK: - Elite Level Expansion (241-300) - 60 sessions
    SprintSessionTemplate(id: 241, name: "Elite Plyometric 10 yd Bounds + Sprint", distance: 10, reps: 8, rest: 120, focus: "Power → Speed", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 242, name: "Elite Complex 20 yd Weighted + Free", distance: 20, reps: 6, rest: 180, focus: "Contrast Training", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 243, name: "Elite 120 yd Speed Endurance", distance: 120, reps: 3, rest: 480, focus: "Speed Endurance", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 244, name: "Elite 150 yd Long Sprint", distance: 150, reps: 2, rest: 600, focus: "Speed Reserve", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 245, name: "Elite Flying 60 yd Max V", distance: 60, reps: 4, rest: 300, focus: "Peak Velocity", level: "Elite", sessionType: LibrarySessionType.sprint),
    
    // MARK: - Specialized Training Methods (301-350) - 50 sessions  
    SprintSessionTemplate(id: 301, name: "Plyometric 5 Bounds + 20 yd Sprint", distance: 20, reps: 6, rest: 150, focus: "Power-Speed", level: "Advanced", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 302, name: "Agility Ladder + 15 yd Sprint", distance: 15, reps: 8, rest: 120, focus: "Coordination-Speed", level: "Intermediate", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 303, name: "Resisted 30 yd + Free 30 yd", distance: 30, reps: 5, rest: 180, focus: "Resistance Training", level: "Advanced", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 304, name: "Assisted Overspeed 40 yd", distance: 40, reps: 4, rest: 240, focus: "Overspeed Training", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 305, name: "Hill Sprint 25 yd Uphill", distance: 25, reps: 6, rest: 180, focus: "Power Development", level: "Advanced", sessionType: LibrarySessionType.sprint),
    
    // MARK: - Recovery & Tempo Expansion (351-380) - 30 sessions
    SprintSessionTemplate(id: 351, name: "Extended Tempo 60 yd ×8", distance: 60, reps: 8, rest: 90, focus: "Aerobic Power", level: "Advanced", sessionType: LibrarySessionType.tempo),
    SprintSessionTemplate(id: 352, name: "Recovery Jog + Strides", distance: 20, reps: 6, rest: 60, focus: "Active Recovery", level: "All Levels", sessionType: LibrarySessionType.activeRecovery),
    SprintSessionTemplate(id: 353, name: "Mobility + Light Tempo", distance: 30, reps: 4, rest: 120, focus: "Movement Prep", level: "All Levels", sessionType: LibrarySessionType.activeRecovery),
    SprintSessionTemplate(id: 354, name: "Technique Focus 15 yd ×10", distance: 15, reps: 10, rest: 90, focus: "Mechanics", level: "Beginner", sessionType: LibrarySessionType.activeRecovery),
    SprintSessionTemplate(id: 355, name: "Float + Stride 40 yd", distance: 40, reps: 5, rest: 150, focus: "Relaxed Speed", level: "Intermediate", sessionType: LibrarySessionType.tempo),
    
    // MARK: - Advanced Pyramid & Complex Sessions (381-420) - 40 sessions
    SprintSessionTemplate(id: 381, name: "Multi-Distance 10-30-50-70 yd", distance: 70, reps: 4, rest: 200, focus: "Progressive Build", level: "Advanced", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 382, name: "Reverse Pyramid 80-60-40-20 yd", distance: 80, reps: 4, rest: 180, focus: "Descending Load", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 383, name: "Wave Pyramid 20-40-30-50 yd", distance: 50, reps: 4, rest: 160, focus: "Variable Stimulus", level: "Advanced", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 384, name: "Complex Pyramid 15-45-75-45-15 yd", distance: 75, reps: 5, rest: 190, focus: "Peak & Return", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 385, name: "Double Peak 20-40-60-40-20 yd", distance: 60, reps: 5, rest: 170, focus: "Dual Peak Training", level: "Advanced", sessionType: LibrarySessionType.sprint),
    
    // MARK: - Sport-Specific & Functional (421-464) - 44 sessions
    SprintSessionTemplate(id: 421, name: "Football Position: Lineman 5 yd ×12", distance: 5, reps: 12, rest: 45, focus: "First Step Power", level: "All Levels", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 422, name: "Football Position: Skill 40 yd ×6", distance: 40, reps: 6, rest: 180, focus: "Breakaway Speed", level: "All Levels", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 423, name: "Basketball Court Sprint 94 ft", distance: 31, reps: 8, rest: 120, focus: "Court Length", level: "All Levels", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 424, name: "Soccer Pitch Sprint 50 yd", distance: 50, reps: 6, rest: 150, focus: "Field Coverage", level: "All Levels", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 425, name: "Multi-Directional 10 yd ×8", distance: 10, reps: 8, rest: 90, focus: "Change of Direction", level: "All Levels", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 426, name: "Lateral + Linear 15 yd", distance: 15, reps: 6, rest: 120, focus: "Multi-Planar", level: "Intermediate", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 427, name: "Backpedal + Sprint 20 yd", distance: 20, reps: 5, rest: 150, focus: "Transition Speed", level: "Advanced", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 428, name: "Reactive Sprint 25 yd", distance: 25, reps: 6, rest: 180, focus: "Reaction Time", level: "All Levels", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 429, name: "Game Simulation 30 yd", distance: 30, reps: 4, rest: 240, focus: "Sport Application", level: "Advanced", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 430, name: "Functional Movement + Sprint", distance: 35, reps: 4, rest: 200, focus: "Movement Integration", level: "All Levels", sessionType: LibrarySessionType.sprint),
    
    // Additional sessions to reach 464 total
    SprintSessionTemplate(id: 431, name: "Elite Competition Prep 40 yd", distance: 40, reps: 3, rest: 300, focus: "Competition Ready", level: "Elite", sessionType: LibrarySessionType.benchmark),
    SprintSessionTemplate(id: 432, name: "Elite Competition Prep 60 yd", distance: 60, reps: 2, rest: 360, focus: "Competition Ready", level: "Elite", sessionType: LibrarySessionType.benchmark),
    SprintSessionTemplate(id: 433, name: "Power Endurance 100 yd ×3", distance: 100, reps: 3, rest: 420, focus: "Power Endurance", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 434, name: "Speed Reserve 200 yd ×2", distance: 200, reps: 2, rest: 720, focus: "Speed Reserve", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 435, name: "Neural Activation 10 yd ×15", distance: 10, reps: 15, rest: 60, focus: "CNS Activation", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 436, name: "Max Velocity 80 yd Flying", distance: 80, reps: 3, rest: 360, focus: "Peak Velocity", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 437, name: "Acceleration Emphasis 25 yd ×8", distance: 25, reps: 8, rest: 150, focus: "Pure Acceleration", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 438, name: "Speed Maintenance 50 yd ×5", distance: 50, reps: 5, rest: 240, focus: "Speed Maintenance", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 439, name: "Elite Recovery Tempo 75 yd ×4", distance: 75, reps: 4, rest: 120, focus: "Active Recovery", level: "Elite", sessionType: LibrarySessionType.tempo),
    SprintSessionTemplate(id: 440, name: "Elite Technical 20 yd ×12", distance: 20, reps: 12, rest: 90, focus: "Technical Refinement", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 441, name: "Elite Contrast 30+60 yd ×4", distance: 60, reps: 4, rest: 240, focus: "Contrast Method", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 442, name: "Elite Cluster 40 yd (3×2)", distance: 40, reps: 6, rest: 180, focus: "Cluster Training", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 443, name: "Elite Wave Load 35-70-35 yd", distance: 70, reps: 3, rest: 300, focus: "Wave Loading", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 444, name: "Elite Potentiation 45 yd ×4", distance: 45, reps: 4, rest: 270, focus: "Post-Activation", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 445, name: "Elite Mechanical 15 yd ×10", distance: 15, reps: 10, rest: 120, focus: "Mechanics Focus", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 446, name: "Elite Rhythm 55 yd ×4", distance: 55, reps: 4, rest: 280, focus: "Rhythm Development", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 447, name: "Elite Progression 65 yd ×3", distance: 65, reps: 3, rest: 320, focus: "Progressive Loading", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 448, name: "Elite Integration 85 yd ×3", distance: 85, reps: 3, rest: 360, focus: "Skill Integration", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 449, name: "Elite Adaptation 95 yd ×2", distance: 95, reps: 2, rest: 420, focus: "Adaptive Response", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 450, name: "Elite Mastery 105 yd ×2", distance: 105, reps: 2, rest: 480, focus: "Movement Mastery", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 451, name: "Elite Precision 115 yd ×2", distance: 115, reps: 2, rest: 540, focus: "Precision Training", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 452, name: "Elite Excellence 125 yd ×2", distance: 125, reps: 2, rest: 600, focus: "Excellence Standard", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 453, name: "Elite Perfection 135 yd ×2", distance: 135, reps: 2, rest: 660, focus: "Perfection Pursuit", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 454, name: "Elite Championship 145 yd ×2", distance: 145, reps: 2, rest: 720, focus: "Championship Level", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 455, name: "Elite Ultimate 160 yd ×2", distance: 160, reps: 2, rest: 780, focus: "Ultimate Performance", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 456, name: "Elite Legendary 175 yd ×2", distance: 175, reps: 2, rest: 840, focus: "Legendary Status", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 457, name: "Elite Mythical 190 yd ×2", distance: 190, reps: 2, rest: 900, focus: "Mythical Achievement", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 458, name: "Elite Transcendent 210 yd ×1", distance: 210, reps: 1, rest: 960, focus: "Transcendent Speed", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 459, name: "Elite Godlike 230 yd ×1", distance: 230, reps: 1, rest: 1020, focus: "Godlike Velocity", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 460, name: "Elite Infinite 250 yd ×1", distance: 250, reps: 1, rest: 1080, focus: "Infinite Potential", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 461, name: "Elite Cosmic 275 yd ×1", distance: 275, reps: 1, rest: 1140, focus: "Cosmic Speed", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 462, name: "Elite Universal 300 yd ×1", distance: 300, reps: 1, rest: 1200, focus: "Universal Mastery", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 463, name: "Elite Dimensional 350 yd ×1", distance: 350, reps: 1, rest: 1260, focus: "Dimensional Shift", level: "Elite", sessionType: LibrarySessionType.sprint),
    SprintSessionTemplate(id: 464, name: "Elite Omnipotent 400 yd ×1", distance: 400, reps: 1, rest: 1320, focus: "Omnipotent Speed", level: "Elite", sessionType: LibrarySessionType.sprint)
]
