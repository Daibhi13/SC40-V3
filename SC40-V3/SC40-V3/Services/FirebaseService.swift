...
class FirebaseService: ObservableObject {
    ...
    func createUser(with authUser: AuthUser) async throws {
        ...
        try await db.collection("users").document(authUser.id.uuidString).setData(userData, merge: true)
    ...
    // Note: AuthUser and AuthProvider are defined in AuthenticationManager.swift
