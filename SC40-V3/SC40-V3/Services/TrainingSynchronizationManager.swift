...
class TrainingSynchronizationManager: ObservableObject {
    ...
    internal let supportedLevels: [TrainingLevel] = [.beginner, .intermediate, .advanced, .elite]
...
// MARK: - TrainingLevel Extension for Pro Support (Legacy)

extension TrainingLevel {
    static var pro: TrainingLevel { .elite } // Map legacy Pro to Elite for compatibility
}
