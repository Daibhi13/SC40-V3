...
public extension UserProfile {
    ...
    private nonisolated(unsafe) static var _sessionsStorage: [String: [TrainingSession]] = [:]
    private nonisolated(unsafe) static var _completedSessionsStorage: [String: [TrainingSession]] = [:]
