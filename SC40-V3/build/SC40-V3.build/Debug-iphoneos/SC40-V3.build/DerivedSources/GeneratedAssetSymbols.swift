...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let trackBackground = DeveloperToolsSupport.ImageResource(name: "track-background", bundle: resourceBundle)

    /// The "usa_sprinter" asset catalog image resource.
    static let usaSprinter = DeveloperToolsSupport.ImageResource(name: "usa_sprinter", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "track-background" asset catalog image.
    static var trackBackground: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .trackBackground)
#else
        .init()
#endif
    }

    /// The "usa_sprinter" asset catalog image.
    static var usaSprinter: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .usaSprinter)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "track-background" asset catalog image.
    static var trackBackground: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .trackBackground)
#else
        .init()
    ...
    /// The "usa_sprinter" asset catalog image.
    static var usaSprinter: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .usaSprinter)
#else
        .init()
