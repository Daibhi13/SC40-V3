...
#ifndef SC40_V3_SWIFT_H
#define SC40_V3_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SC40_V3",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSURL;
SWIFT_CLASS("_TtC7SC40_V311AppDelegate")
@interface AppDelegate : NSObject <UIApplicationDelegate>
- (BOOL)application:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (BOOL)application:(UIApplication * _Nonnull)app openURL:(NSURL * _Nonnull)url options:(NSDictionary<UIApplicationOpenURLOptionsKey, id> * _Nonnull)options SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=9.0,deprecated=26.0,message="Use scene(_:openURLContexts:) instead");
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASAuthorizationController;
@class ASAuthorization;
SWIFT_CLASS("_TtC7SC40_V319AppleSignInDelegate")
@interface AppleSignInDelegate : NSObject <ASAuthorizationControllerDelegate>
...
SWIFT_CLASS("_TtC7SC40_V338AppleSignInPresentationContextProvider")
@interface AppleSignInPresentationContextProvider : NSObject <ASAuthorizationControllerPresentationContextProviding>
...
SWIFT_CLASS("_TtC7SC40_V321AuthenticationManager")
@interface AuthenticationManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC7SC40_V310GPSManager")
...
@class CLLocation;
@interface GPSManager (SWIFT_EXTENSION(SC40_V3)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status;
@end

SWIFT_CLASS("_TtC7SC40_V320InstagramAuthService")
@interface InstagramAuthService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASWebAuthenticationSession;
@interface InstagramAuthService (SWIFT_EXTENSION(SC40_V3)) <ASWebAuthenticationPresentationContextProviding>
...
SWIFT_CLASS("_TtC7SC40_V315LocationService")
@interface LocationService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface LocationService (SWIFT_EXTENSION(SC40_V3)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status;
@end
...
SWIFT_CLASS("_TtC7SC40_V313SceneDelegate")
