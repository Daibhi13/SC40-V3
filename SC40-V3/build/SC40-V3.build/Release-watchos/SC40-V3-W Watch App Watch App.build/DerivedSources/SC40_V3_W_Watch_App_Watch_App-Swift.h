...
#ifndef SC40_V3_W_WATCH_APP_WATCH_APP_SWIFT_H
#define SC40_V3_W_WATCH_APP_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SC40_V3_W_Watch_App_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC29SC40_V3_W_Watch_App_Watch_App25GPS40ydTTStopwatchManager")
@interface GPS40ydTTStopwatchManager : NSObject <CLLocationManagerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
@end

SWIFT_CLASS("_TtC29SC40_V3_W_Watch_App_Watch_App19GPSStopwatchManager")
@interface GPSStopwatchManager : NSObject <CLLocationManagerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
@end
...
SWIFT_CLASS("_TtC29SC40_V3_W_Watch_App_Watch_App15WatchGPSManager")
@interface WatchGPSManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface WatchGPSManager (SWIFT_EXTENSION(SC40_V3_W_Watch_App_Watch_App)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status;
@end

SWIFT_CLASS("_TtC29SC40_V3_W_Watch_App_Watch_App21WatchHealthKitService")
@interface WatchHealthKitService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class HKLiveWorkoutBuilder;
@class HKSampleType;
@interface WatchHealthKitService (SWIFT_EXTENSION(SC40_V3_W_Watch_App_Watch_App)) <HKLiveWorkoutBuilderDelegate>
...
@class NSDate;
@interface WatchHealthKitService (SWIFT_EXTENSION(SC40_V3_W_Watch_App_Watch_App)) <HKWorkoutSessionDelegate>
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC29SC40_V3_W_Watch_App_Watch_App26WatchSessionTriggerManager")
@interface WatchSessionTriggerManager : NSObject <WCSessionDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC29SC40_V3_W_Watch_App_Watch_App19WatchWorkoutManager")
@interface WatchWorkoutManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface WatchWorkoutManager (SWIFT_EXTENSION(SC40_V3_W_Watch_App_Watch_App)) <HKWorkoutSessionDelegate>
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didChangeToState:(HKWorkoutSessionState)toState fromState:(HKWorkoutSessionState)fromState date:(NSDate * _Nonnull)date;
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didFailWithError:(NSError * _Nonnull)error;
@end

@interface WatchWorkoutManager (SWIFT_EXTENSION(SC40_V3_W_Watch_App_Watch_App)) <HKLiveWorkoutBuilderDelegate>
- (void)workoutBuilder:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder didCollectDataOfTypes:(NSSet<HKSampleType *> * _Nonnull)collectedTypes;
- (void)workoutBuilderDidCollectEvent:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder;
@end
...
SWIFT_CLASS("_TtC29SC40_V3_W_Watch_App_Watch_App19WorkoutMusicManager")
@interface WorkoutMusicManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface WorkoutWatchViewModel (SWIFT_EXTENSION(SC40_V3_W_Watch_App_Watch_App)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
@end

@interface WorkoutWatchViewModel (SWIFT_EXTENSION(SC40_V3_W_Watch_App_Watch_App)) <WCSessionDelegate>
- (void)session:(WCSession * _Nonnull)session activationDidCompleteWithState:(WCSessionActivationState)activationState error:(NSError * _Nullable)error;
- (void)session:(WCSession * _Nonnull)session didReceiveMessage:(NSDictionary<NSString *, id> * _Nonnull)message;
@end
