...
func getSessionTypeDistribution(frequency: Int) -> SessionTypeDistribution {
    switch frequency {
    case 1:
        return SessionTypeDistribution(speed: 1.0, flying: 0.0, endurance: 0.0, pyramidUp: 0.0, pyramidDown: 0.0, pyramidUpDown: 0.0, activeRecovery: 0.0, recovery: 0.0)
    case 2:
        return SessionTypeDistribution(speed: 0.5, flying: 0.0, endurance: 0.5, pyramidUp: 0.0, pyramidDown: 0.0, pyramidUpDown: 0.0, activeRecovery: 0.0, recovery: 0.0)
    case 3:
        return SessionTypeDistribution(speed: 0.4, flying: 0.2, endurance: 0.2, pyramidUp: 0.2, pyramidDown: 0.0, pyramidUpDown: 0.0, activeRecovery: 0.0, recovery: 0.0)
    case 4:
        return SessionTypeDistribution(speed: 0.3, flying: 0.2, endurance: 0.2, pyramidUp: 0.15, pyramidDown: 0.15, pyramidUpDown: 0.0, activeRecovery: 0.0, recovery: 0.0)
    case 5:
        return SessionTypeDistribution(speed: 0.25, flying: 0.2, endurance: 0.2, pyramidUp: 0.15, pyramidDown: 0.1, pyramidUpDown: 0.1, activeRecovery: 0.0, recovery: 0.0)
    case 6:
        return SessionTypeDistribution(speed: 0.2, flying: 0.18, endurance: 0.17, pyramidUp: 0.15, pyramidDown: 0.1, pyramidUpDown: 0.1, activeRecovery: 0.1, recovery: 0.0)
    case 7:
        return SessionTypeDistribution(speed: 0.18, flying: 0.16, endurance: 0.16, pyramidUp: 0.14, pyramidDown: 0.1, pyramidUpDown: 0.1, activeRecovery: 0.08, recovery: 0.08)
    default:
