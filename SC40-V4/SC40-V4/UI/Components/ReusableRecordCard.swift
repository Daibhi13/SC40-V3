...
struct ReusableRecordCard: View {
    var recordTitle: String
    var recordValue: String
    var body: some View {
        ZStack {
            // Liquid glass background for ReusableRecordCard
...
// MARK: - Previews
#if DEBUG
#Preview("1. Personal Best Record") {
    ReusableRecordCard(recordTitle: "Personal Best", recordValue: "4.89s")
        .frame(width: 200, height: 100)
        .preferredColorScheme(.dark)
}

#Preview("2. Sprint Record") {
    ReusableRecordCard(recordTitle: "40-Yard Sprint", recordValue: "4.72s")
        .frame(width: 200, height: 100)
        .preferredColorScheme(.dark)
}

#Preview("3. Distance Record") {
    ReusableRecordCard(recordTitle: "Longest Sprint", recordValue: "100m")
        .frame(width: 200, height: 100)
        .preferredColorScheme(.dark)
}
#endif
