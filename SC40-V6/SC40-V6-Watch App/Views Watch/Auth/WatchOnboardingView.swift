            ...
            VStack(spacing: 16) {
                ...
                HStack(spacing: 4) {
                    ForEach(0..<3) { index in
                        Circle()
                            .fill(index <= currentStep ? Color(red: 1.0, green: 0.8, blue: 0.0) : Color(red: 0.1, green: 0.1, blue: 0.15).opacity(0.3))
                    ...
                    if currentStep > 0 {
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 8, style: .continuous)
                                .fill(Color(red: 0.1, green: 0.1, blue: 0.15).opacity(0.2))
                        )
                        .buttonStyle(.plain)
                    }
            ...
            VStack(spacing: 8) {
                ForEach(levels, id: \.self) { level in
                    Button(action: {
                        ...
                        .foregroundColor(selectedLevel == level ? Color(red: 1.0, green: 0.8, blue: 0.0) : Color(red: 0.95, green: 0.95, blue: 0.95))
                        .padding(.horizontal, 12)
                        .padding(.vertical, 8)
                        .background(
                            RoundedRectangle(cornerRadius: 8, style: .continuous)
                                .fill(selectedLevel == level ? Color(red: 1.0, green: 0.8, blue: 0.0).opacity(0.1) : Color(red: 0.1, green: 0.1, blue: 0.15).opacity(0.1))
                        )
                        .overlay(
                            RoundedRectangle(cornerRadius: 8, style: .continuous)
                                .stroke(selectedLevel == level ? Color(red: 1.0, green: 0.8, blue: 0.0).opacity(0.4) : Color.clear, lineWidth: 1)
                        )
                    }
                    .buttonStyle(.plain)
                }
            ...
            VStack(spacing: 12) {
                ...
                .background(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .fill(Color(red: 0.1, green: 0.1, blue: 0.15).opacity(0.1))
                )
