...
struct OnboardingRequiredView: View {
    ...
    var body: some View {
        ZStack {
            ...
            LinearGradient(
                colors: [Color(red: 1.0, green: 0.8, blue: 0.0).opacity(0.3), Color(red: 0.95, green: 0.95, blue: 0.95).opacity(0.2), Color.black],
    ...
    private var actionButtonsView: some View {
        VStack(spacing: WatchAdaptiveSizing.smallPadding) {
            ...
            Button(action: {
                ...
                .background(
                    LinearGradient(
                        colors: [Color(red: 1.0, green: 0.8, blue: 0.0), Color(red: 0.95, green: 0.95, blue: 0.95)],
                        startPoint: .leading,
                        endPoint: .trailing
                    )
                )
